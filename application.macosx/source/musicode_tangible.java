...
public class musicode_tangible extends PApplet {
...
public void updateSignals(char current){
...
public String getText(note thisNote){
  String type = " ";
...
public void callEdge(int number){
...
public void stackFunction(int number){
...
public void playNote(int playIndex){
...
public void edgeIn(int number){
  //if it received a signal from an edge
  edges[number] = 1;
}

//recording functions
public void startRecording(int functionNumber) {
  butts[functionNumber].startRecord();
  recorder = functionNumber;
}

public void addToRecorder(int button, int type){
  note thisNote;
...
public void functionButtonPress(int functionNumber) {
...
public void noteButtonPress(int note){
  //println("Note button");
  if(recorder != -1){
...
public void edgeButtonPress(int number, int type){ 
...
public void changeQuestion(int dir){
  if (dir == 1){
    if(qno < 7)
      qno += 1;
  }
...
public void keyPressedCheck(char KEY) {
  println(KEY);
  int keyIndex = -1;
  if (KEY == 'p'){
    println("Play notes!");
...
public class Function{
  ...
  public void addNote(note enteringNote) {
    recorder.add(enteringNote); 
  }
  
  public void startPlay(ArrayList<note> playStack){
...
public class note {
  ...
  public String GetMusic(int number, int set)
  {
    String ret = "";
    if(number == 0)
    {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "musicode_tangible" };
    if (passedArgs != null) {
